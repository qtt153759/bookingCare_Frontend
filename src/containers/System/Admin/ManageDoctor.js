    ...
    componentDidUpdate(prevProps, prevState, snapshot) {
        ...
        if (prevProps.language !== this.props.language) {
            let dataSelect = this.buildDataInputSelect(
                this.props.allDoctors,
                "USERS"
            ); //mục tiêu là gọi lại hàm này để setState vì nó ko thể update language
            let { resPrice, resPayment, resProvince } =
                this.props.allRequiredDoctorInfor;
            let dataSelectPrice = this.buildDataInputSelect(resPrice, "PRICE");
            let dataSelectPayment = this.buildDataInputSelect(
                ...
                <div className="more-infor-extra row">
                    <div className="col-4 form-group">
                        ...
                        <Select
                            ...
                            name="selectedPrice" //tương tự như mk truyền 1 cái id vào function onChange(biến name do thư viện quy định)
                        />
                    </div>
                    <div className="col-4 form-group">
                        <label>
